export default [
  ...
  },
  {
    ...
    longDescription:
      "June 2019 - Teenagers go through phases. Sometimes they're moody. Sometimes, they're studious. They'll often pick up and abandon hobbies at the drop of a hat. This is a normal self exploratory process that's crucial for well rounded development and a successful adulthood. It only becomes problematic when one of these hobbies or habits becomes too consuming.\n" +
      "\n" +
      "Are your teenagers favorite pastimes verging on becoming addictions? Learn to recognize the signs and plan to step in if things seem to be getting out of hand.\n" +
      "\n" +
      "1. Junk Food\n" +
  ...
  },
  {
    ...
    longDescription:
      " When you have been hit by the spending bug, it's hard to turn things around. All you want to do is buy yourself something nice, right? Shopping can trigger pleasure centres in the brain and thus is a hard habit to break out of. Here's how to make your brain understand that you need to save, not spend.\n" +
      "\n" +
      "Keep Busy\n" +
  ...
  },
  {
    ...
    longDescription:
      ...
      "\n" +
      "John Casablancas. Julian Marques\n" +
